...
static inline void nr_blit_ortho(uint32_t *dst, int dst_width, int dst_height, int x , int y , uint32_t *src, int src_width, int src_height, int xsrc, int ysrc, int w, int h, double hjust, double vjust, bool respect_alpha) {
  ...
  if (fun == NULL) {
    fun = (void (*)(uint32_t *dst, int dst_width, int dst_height, int x , int y , uint32_t *src, int src_width, int src_height, int xsrc, int ysrc, int w, int h, double hjust, double vjust, bool respect_alpha)) R_GetCCallable("nara", "nr_blit_ortho");
  }
