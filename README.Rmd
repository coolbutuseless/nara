...
`{nara}` provides tools for working with R's native raster image format to 
enable fast graphics rendering.

### Why?

native raster images are fast enough to use for rendering at speed >30 frames-per-second.  
