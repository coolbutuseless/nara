...
for (i in c(1:10, rep(10, 10))) { # sprite numbers
  ...
  grid.raster(back)
  nr_blit(dst = fore, src = deer_sprites[[i]], x = N/2, y = N/1.75, hjust = 0.5, vjust = 1)
...
* [Creating, transforming, reading, writing native raster images](https://coolbutuseless.github.io/package/nara/articles/conversion.html)
...
for (idx in seq(141)) {
  ...
  nr_fill(nr, 'grey80')                    
  sprite_idx <- floor((i/3) %% 5) + 11
  nr_blit(dst = nr, src = deer_sprites[[sprite_idx]], x = i, y = 0) # copy deer to image
